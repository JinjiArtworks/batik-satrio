    ...
    <div class="container grid grid-cols-12 items-start gap-6 pt-4 pb-16">
        ...
        <div class="col-span-9 space-y-4">
            ...
            <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                ...
                <div class="w-1/3">
                    <h2 class="text-gray-800 text-xl font-medium ">Dining Table</h2>
                    <p class="text-gray-500 text-sm">Availability: <span class="text-green-600">In Stock</span></p>
                </div>
                <div class="text-gray-600 text-lg font-semibold">$320.00</div>
                <a href="#"
            ...
            <div class="flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                ...
                <div class="w-1/3">
                    <h2 class="text-gray-800 text-xl font-medium ">Sofa</h2>
                    <p class="text-gray-500 text-sm">Availability: <span class="text-red-600">Out of Stock</span></p>
                </div>
                <div class="text-gray-600 text-lg font-semibold">$320.00</div>
                <a href="#"
                    class="cursor-not-allowed px-6 py-2 text-center text-sm text-white bg-red-400 border border-red-400 rounded transition  font-roboto font-medium">add
                    to cart</a>
