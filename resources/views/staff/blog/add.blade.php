    ...
    <main class="h-full overflow-y-auto">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($blog as $key => $item)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <form method="GET" action="{{ route('blog.edit-blog', ['id' => $item->id]) }}">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <form method="GET" action="{{ route('blog.delete-blog', ['id' => $item->id]) }}">
                                            <button type="submit"
        ...
        <div class="container px-6 mx-auto grid">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" action="{{ route('blog.store-blog') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button
                        class="confirmAdd px-3 py-1 mt-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        Submit
                    </button>
                </form>
            </div>
...
@section('script')
    <script>
        ...
        $('.confirmAdd').click(function(event) {
            var form = $(this).closest("form");
            event.preventDefault();
            Swal.fire({
