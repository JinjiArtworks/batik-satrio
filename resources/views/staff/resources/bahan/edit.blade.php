    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" action="{{ route('resources.update-bahan', ['id' => $bahan->id]) }}"
                    ...
                    <label class="block text-sm">
                        ...
                        <input name="name" value="{{ $bahan->nama }}"
                    ...
                    <label class="block text-sm mt-4">
                        ...
                        <input name="stock" value="{{ $bahan->stock_bahan }}" readonly
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input">
                        <span><small>*stock bahan tidak bisa diubah.</small></span>
                    ...
                    <label class="block text-sm mt-4 ">
                        ...
                        <input name="satuan" value="{{ $bahan->satuan }}"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input">
                    </label>
                    <label class="block text-sm mt-4 ">
                        <span class="text-gray-700 dark:text-gray-400">
